...
public class QuestionBankLinks {
    ...
    public static final String GET_QUESTIONBANKS_BY_YEAR = "/year/{year}";
    public static final String GET_QUESTIONBANKS_BY_SUBJECT = "/subject/{subject}";
    public static final String ADD_QUESTIONBANK = "/addquestionBank";
    public static final String GET_QUESTIONBANK_BY_SUBJECT_AND_YEAR = "/{subject}/{year}";
